...
import f from '../../Img/Socialicons/f.png';
import g from '../../Img/Socialicons/g.png';
import p from '../../Img/Socialicons/p.png';
import t from '../../Img/Socialicons/t.png';
            ...
            <div className="details" key={item._id}>
                ...
                <div className="box">
                    ...
                    <div className="countDiv">
                        <button className="buttonMinus"><span>-</span></button>
                        <button className="buttonNumber"><span>2</span></button>
                        <button className="buttonPlus"><span>+</span></button>
                    </div>
